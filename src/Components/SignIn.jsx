...
const SignIn = () => {
  ...
  return (
    <div className="">
      ...
      <div className="mt-6">
      <h1 className="text-3xl mb-2 text-center font-bold">Inicia sesión</h1>
        <div className="border border-green-400 mx-auto w-11/13 md:w-2/5 rounded py-8 px-4 md:px-8">
          <form>
            {error !== null && (
